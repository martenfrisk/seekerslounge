		...
		<div className="sticky w-full py-0 mt-0 md:mb-0 md:w-1/4 md:max-w-sm ">
			...
			<div className="w-full h-auto px-4 py-4 font-sans leading-relaxed text-justify md:px-6">
				{infoView && (
					<div>
						<div>
							<p className="mb-4 text-blue-800">Thanks for using my silly website. This site is moving to <a className="underline" href="https://seekerslounge.pcast.site">seekerslounge.pcast.site</a> with improved performance and (hopefully) some new features. Feel free to test it out! Stay flippy!</p>
							<p className="my-4">
